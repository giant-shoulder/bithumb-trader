...
MIN_PRICE_KRW = 200          # 최소 코인 가격 (원) - 200원 미만은 1원=0.5%+ 슬리피지 손절 불가피 (50→200, 2026-04-11)

# 매수 실행
MAX_POSITION_KRW = 1000000   # 코인당 최대 투자금액 (원)
BUY_SPLIT = 5                # 불타기 분할 횟수
BUY_UNIT_KRW = 200000        # 1회 매수 금액 (10만→20만)
...
# 소액 포지션 방지
MIN_BUY_KRW = 100_000        # 최소 실제 매수금액 (원) - 잔고 부족 시 소액 포지션 차단 (BUY_UNIT_KRW의 50%)
MIN_POSITION_KRW = 5_000     # 포지션 인식 최소금액 (원) - 이하는 더스트로 간주하고 스킵
