...
# ===== 최소 가격 / 스프레드 =====
# 200원 미만: 1원 틱이 손절폭(0.8%)보다 커서 손절가 정밀도 붕괴 (50원 코인 → 1틱=2%, 설계값 무의미)
# 500원→100원→1원으로 낮출 때마다 손절이 설계보다 더 크게 발동됨 (2026-05-31 원인)
MIN_PRICE_KRW = 200          # 최소 코인 가격 (원) - 틱 크기 대비 손절 정밀도 보장 기준
